...
| Guided first-run setup | Select one iPhone, generate local pairing configuration and a narrow Tailscale grant, configure Serve safely, and start the bridge without exposing its signing key. | [Spec](specs/2026-09-14-guided-first-run-setup-design.md) | 2026-09-14 | — | — | — |
