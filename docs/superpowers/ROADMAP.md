...
| Login startup and bounded process retries | Start the bridge in the Mac user session and retry up to three failed exits. | [Spec](specs/2026-09-16-login-autostart-design.md) | 2026-09-16 | — | — | — |
